...
int main() {
    ...
    znn::Opts.LearnRate = 3.f;
    znn::Opts.BackLearnTimesPerBatch = 3;
    znn::Opts.IterationTimes = 0;
    znn::Opts.FitnessThreshold = 0.99f;
    znn::Opts.IterationCheckPoint = 500;
    znn::Opts.ThreadCount = 16;
    znn::Opts.MutateAddNeuronRate = 0.5f;
    znn::Opts.MutateAddConnectionRate = 0.99f;
    znn::Opts.PopulationSize = 24;
    znn::Opts.NewSize = 1;
    znn::Opts.KeepComplexSize = 3;
    znn::Opts.KeepWorstSize = 0;
    znn::Opts.ChampionToNewSize = 12;
    znn::Opts.ChampionKeepSize = 6;
    znn::Opts.WeightRange = 10.f;
    znn::Opts.BiasRange = 30.f;
    znn::Opts.MutateBiasRate = .5f;
    znn::Opts.MutateWeightRate = .5f;
